...
int main()
{
	...
	computeError(vv3dLiDARRealPose, vv3dLiDARInitialPoseGuess, vv3dLiDARFinalPose1);
	////////////Point to Point Edge G2O///////////////////
	...
	vFra2FraTransEdges.push_back(Fra2FraTransEdge(0, 1, transFinal01));
	vFra2FraTransEdges.push_back(Fra2FraTransEdge(0, 2, transFinal02));
	vFra2FraTransEdges.push_back(Fra2FraTransEdge(0, 3, transFinal03));
	vFra2FraTransEdges.push_back(Fra2FraTransEdge(1, 2, transFinal12));
	vFra2FraTransEdges.push_back(Fra2FraTransEdge(1, 3, transFinal13));
	vFra2FraTransEdges.push_back(Fra2FraTransEdge(2, 3, transFinal23));

	G2O_OptimizerFra2Fra(vv3dLiDARInitialPoseGuess, vFra2FraTransEdges, vv3dLiDARFinalPose2);
	computeError(vv3dLiDARRealPose, vv3dLiDARInitialPoseGuess, vv3dLiDARFinalPose2);
	//////////////Frame to Frame Edge G2O//////////////////
